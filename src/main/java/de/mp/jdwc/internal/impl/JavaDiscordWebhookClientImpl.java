package de.mp.jdwc.internal.impl;
/*
 *  Created by Maurice-Pascal at 20:06 on 02.10.2020
 */
...
public class JavaDiscordWebhookClientImpl implements JavaDiscordWebhookClient {
    ...
    public JavaDiscordWebhookClientImpl(String token, Long id) {
        url += "/"+ id +"/"+token;
    }
